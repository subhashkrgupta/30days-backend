        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 sm:px-10 shadow-xl shadow-gray-200 dark:shadow-none border border-gray-100 dark:border-gray-700 rounded-2xl">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition"
              >
